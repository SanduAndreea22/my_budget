...
AUTH_PASSWORD_VALIDATORS = [
    {"NAME": "accounts.password_validators.FriendlyUserAttributeSimilarityValidator"},
    {"NAME": "accounts.password_validators.FriendlyMinimumLengthValidator"},
    {"NAME": "accounts.password_validators.FriendlyCommonPasswordValidator"},
    {"NAME": "accounts.password_validators.FriendlyNumericPasswordValidator"},
]
